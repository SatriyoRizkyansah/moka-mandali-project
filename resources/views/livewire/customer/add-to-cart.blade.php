<div class="flex items-center space-x-2">
    ...
    <button wire:click="addToCart" 
            ...
            class="flex-1 bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
